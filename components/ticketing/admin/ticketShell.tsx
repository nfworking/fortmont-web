...
import { AppSidebar } from "@/components/ticketing/admin/app-sidebar";
import { SiteHeader } from "@/components/ticketing/admin/site-header";
...
const DASHBOARD_TITLES: Array<{ path: string; title: string }> = [
  { path: "/admin_ticketing/dashboard", title: "Dashboard" },
];
