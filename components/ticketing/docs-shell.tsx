...
export function DocsShell({ children, user, articles }: DocsShellProps) {
  ...
  return (
    <div className="min-h-screen bg-transparent backdrop-blur flex">
      {/* Mobile overlay */}
      {sidebarOpen && (
        <div
      ...
      <aside
        className={cn(
          "fixed top-0 left-0 z-50 h-full w-64 border-r bg-black backdrop-blur transition-transform duration-300 lg:translate-x-0",
